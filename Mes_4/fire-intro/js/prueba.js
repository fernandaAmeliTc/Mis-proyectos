  ...
  // For Firebase JS SDK v7.20.0 and later, measurementId is optional
    ...
    function listPosts(data){
        ...
        if(data.length > 0){
                ...
                const divPost = `
                    <div style='border:solid 2px;'>
                        ...
                        <span>Publicado el: ${doc.day}/${doc.month}/${doc.year}/${doc.fecha}</span>
                            <button  class="show_buttons" id="show_buttons"> <img src="img/button.svg" ></button>
                            <button   id="show_edit" data-id="${document.id}" class="btn btn-warning btn-edit-post"> <img src="img/edit.svg" ></button>
                            <button   id="show_cut" data-id="${document.id}" class="btn btn-danger btn-delete-post"><img src="img/cut.svg" ></button>
                    </div>
                    <hr>
                `;
                content += divPost;
            ...
            // funcion utilizada
            // const show_buttons_two = document.querySelectorAll("#show_buttons");
            // $(show_buttons_two).click(function(e){
            //         alert("click");
            //         $("#show_edit").show();
            //         $("#show_cut").show();
